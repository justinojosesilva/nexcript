export function inviteEmailTemplate(args: {
  ...
  const { inviterName, organizationName, inviteeEmail, inviteUrl } = args;
    ...
    <body>
      <div class="container">
        <div class="content">
          ...
          <p style="word-break: break-all; font-size: 12px; color: #666; background-color: #f5f5f5; padding: 10px; border-radius: 4px;">${inviteUrl}</p>

          <div class="warning">
            <strong>⏰ Este convite expira em 48 horas</strong>
          </div>
